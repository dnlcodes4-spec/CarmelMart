...
export const fastlink = {
  ...
  /** The detail endpoint allows PUT/PATCH/DELETE — correcting a pickup must not
   *  create a rival record, since the old one keeps is_default: true. */
  updatePickupAddress:  (id, body)   => request(`pickup-addresses/${id}/`, { method: "PATCH", body }),
  deletePickupAddress:  (id)         => request(`pickup-addresses/${id}/`, { method: "DELETE" }),
