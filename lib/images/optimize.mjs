// Loaded lazily (not a top-level import) so `next build` page-data collection
// never evaluates sharp's native binary at import time — that hard-fails the
// build when the platform binary isn't present yet.
let sharpPromise;
function loadSharp() {
